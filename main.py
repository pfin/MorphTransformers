...
class CvT(nn.Module):
    def __init__(self, image_size, in_channels, num_classes, dim=16, kernels=[5, 3, 3], strides=[4, 2, 2],
                 heads=[1, 3, 3] , depth = [1, 1, 4], pool='cls', dropout=0.3, emb_dropout=0.2, scale_dim=4):
        super().__init__()
